...
pub(crate) type k4abt_tracker_set_temporal_smoothing = fn(
    tracker_handle: k4abt_tracker_t,
    smoothing_factor: f32,
);

pub(crate) type k4abt_tracker_enqueue_capture = fn(
    tracker_handle: k4a_tracker_t,
...
pub(crate) type k4abt_frame_get_body_id = fn(
    body_frame_handle: k4abt_frame_t,
    index: u32,
) -> u32;
...
pub(crate) type k4abt_frame_get_body_index_map = fn(body_frame_handle: k4abt_frame_t) -> k4a_image_t;
